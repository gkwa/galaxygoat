...
// NewHTMLProcessor creates a new HTMLProcessor with the specified elements to remove
func NewHTMLProcessor(elementsToRemove string) (*HTMLProcessor, error) {
	...
	return &HTMLProcessor{
		parser:      &parser.NetHTMLParser{},
		transformer: &transformer.ElementRemover{},
